...
The game is based of the quarry, a cinematic game made by supermassive. For this project we intend to have 2 characters that the game will switch between. One trapped the other solving puzzles to get the trapped person out. When making this game the main things that I will find challenging is the conversion fro unity to unreal (code to blueprints)
